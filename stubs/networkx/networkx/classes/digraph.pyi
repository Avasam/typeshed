...
from networkx.classes.reportviews import DiDegreeView, InDegreeView, OutDegreeView, OutEdgeView
...
class DiGraph(Graph[_Node]):
    ...
    @cached_property
    def in_degree(self) -> InDegreeView[_Node]: ...
    @cached_property
    def out_degree(self) -> OutDegreeView[_Node]: ...
