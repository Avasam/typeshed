...
@_dispatchable
def relaxed_caveman_graph(l: int, k: int, p: float, seed: Incomplete | None = None): ...
@_dispatchable
def random_partition_graph(sizes: Collection[int], p_in: float, p_out: float, seed: Incomplete | None = None, directed=False): ...
@_dispatchable
def planted_partition_graph(l: int, k: int, p_in: float, p_out: float, seed: Incomplete | None = None, directed=False): ...
@_dispatchable
def gaussian_random_partition_graph(
    n: int, s: float, v: float, p_in: float, p_out: float, directed=False, seed: Incomplete | None = None
): ...
@_dispatchable
