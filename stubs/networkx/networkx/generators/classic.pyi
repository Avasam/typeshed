...
@_dispatchable
def full_rary_tree(r: int, n: int, create_using: Incomplete | None = None): ...
@_dispatchable
def kneser_graph(n, k) -> Graph[Incomplete]: ...
@_dispatchable
def balanced_tree(r: int, h: int, create_using: Incomplete | None = None): ...
@_dispatchable
def barbell_graph(m1, m2, create_using: Incomplete | None = None): ...
@_dispatchable
def binomial_tree(n: int, create_using: Incomplete | None = None): ...
@_dispatchable
...
@_dispatchable
def empty_graph(n: int | Iterable[Incomplete] = 0, create_using: Incomplete | None = None, default=...): ...
@_dispatchable
...
@_dispatchable
def path_graph(n: int | Iterable[Incomplete], create_using: Incomplete | None = None): ...
@_dispatchable
def star_graph(n: int | Iterable[Incomplete], create_using: Incomplete | None = None): ...
@_dispatchable
def tadpole_graph(m, n, create_using: Incomplete | None = None) -> Graph[Incomplete] | Incomplete: ...
@_dispatchable
def trivial_graph(create_using: Incomplete | None = None): ...
@_dispatchable
def turan_graph(n: int, r: int): ...
@_dispatchable
def wheel_graph(n: int | Iterable[Incomplete], create_using: Incomplete | None = None): ...
@_dispatchable
