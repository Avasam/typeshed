...
class QueryApiAsync(_BaseQueryApi):
    ...
    async def query(self, query: str, org: Incomplete | None = ..., params: dict | None = ...) -> TableList: ...
    ...
    async def query_raw(self, query: str, org: Incomplete | None = ..., dialect=..., params: dict | None = ...): ...
