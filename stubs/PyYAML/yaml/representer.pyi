...
class BaseRepresenter:
    yaml_representers: ClassVar[dict[type, Callable[[BaseRepresenter, Any], Node]]]
    yaml_multi_representers: ClassVar[dict[type, Callable[[BaseRepresenter, Any], Node]]]
    ...
    def represent_sequence(self, tag: str, sequence: Iterable, flow_style: bool | None = ...) -> SequenceNode: ...
    def represent_mapping(
        self, tag: str, mapping: SupportsItems | Iterable[tuple[Any, Any]], flow_style: bool | None = ...
    ) -> MappingNode: ...
...
class SafeRepresenter(BaseRepresenter):
    ...
    def represent_list(self, data: Iterable) -> SequenceNode: ...
    def represent_dict(self, data: SupportsItems | Iterable[tuple[Any, Any]]) -> MappingNode: ...
    def represent_set(self, data: Iterable) -> MappingNode: ...
...
class Representer(SafeRepresenter):
    ...
    def represent_tuple(self, data: Iterable) -> SequenceNode: ...
    ...
    def represent_ordered_dict(self, data: Mapping) -> SequenceNode: ...
