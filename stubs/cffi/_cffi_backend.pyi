...
class FFI:
    ...
    def unpack(self, cdata: CData, length: int) -> bytes | str | list: ...
...
def new_enum_type(__name: str, __enumerators: tuple[str, ...], __enumvalues: tuple, __basetype: CType) -> CType: ...
...
def unpack(cdata: _CDataBase, length: int) -> bytes | str | list: ...
