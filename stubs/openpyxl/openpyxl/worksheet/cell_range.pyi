...
from openpyxl.descriptors.sequence import UniqueSequence, _UniqueSequenceParam
...
class MultiCellRange(Strict):
    ranges: UniqueSequence[CellRange, Literal[False], Literal[False]]
    def __init__(self, ranges: _UniqueSequenceParam[CellRange | str | None] = ...) -> None: ...
    def __contains__(self, coord): ...
