...
class AsyncFunctionCommands:
    ...
    async def function_list(self, library: str | None = ..., withcode: bool | None = ...) -> Awaitable[list] | list: ...
    async def fcall(self, function, numkeys: int, *keys_and_args: list | None) -> Awaitable[str] | str: ...
    async def fcall_ro(self, function, numkeys: int, *keys_and_args: list | None) -> Awaitable[str] | str: ...
    ...
    async def function_stats(self) -> Awaitable[list] | list: ...
