...
class Pipeline(Redis[_StrType], Generic[_StrType]):
    ...
    def execute(self, raise_on_error: bool = ...) -> list: ...
    ...
    def scan_iter(self, match: _Key | None = ..., count: int | None = ..., _type: str | None = ...) -> Iterator: ...  # type: ignore[override]
    def sscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> Pipeline[_StrType]: ...  # type: ignore[override]
    def sscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> Iterator: ...
    def hscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> Pipeline[_StrType]: ...  # type: ignore[override]
    def hscan_iter(self, name, match: _Key | None = ..., count: int | None = ...) -> Iterator: ...
    def zscan_iter(
