...
from .client import CaseInsensitiveDict, PubSub, Redis, _ParseResponseOptions, _StrType
from .commands import CommandsParser, RedisClusterCommands
from .connection import Connection, ConnectionPool, _ConnectionPoolOptions
...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands[_StrType], Generic[_StrType]):
    ...
    def get_node_from_key(self, key: EncodableT, replica: bool = False) -> ClusterNode | None: ...
...
class ClusterPubSub(PubSub):
    ...
    def get_sharded_message(  # type: ignore[override]  # Different signature from supertype
        self, ignore_subscribe_messages: bool = ..., timeout: float = ..., target_node: Incomplete | None = ...
    ): ...
    health_check_response_counter: int
    def ssubscribe(self, *args, **kwargs) -> None: ...
    def sunsubscribe(self, *args) -> None: ...  # type: ignore[override]  # Different signature from supertype
    def get_redis_connection(self) -> Redis[Any] | None: ...
    def disconnect(self) -> None: ...

class ClusterPipeline(RedisCluster[_StrType], Generic[_StrType]):
    ERRORS_ALLOW_RETRY: ClassVar[Incomplete]
    ...
    def eval(self) -> None: ...  # type: ignore[override]  # Different signature from supertype
    def multi(self) -> None: ...
