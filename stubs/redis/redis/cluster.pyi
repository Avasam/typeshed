...
def get_connection(redis_node: Redis, *args, **options: _ConnectionPoolOptions) -> Connection: ...
...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands[_StrType], Generic[_StrType]):
    ...
    cluster_response_callbacks: CaseInsensitiveDict[str, Callable]
...
class ClusterNode:
    ...
    def __init__(self, host: str, port: int, server_type: str | None = ..., redis_connection: Redis | None = ...) -> None: ...
...
class NodesManager:
    ...
    def create_redis_node(self, host: str, port: int | str, **kwargs: Any) -> Redis: ...
...
class ClusterPubSub(PubSub):
    ...
    def set_pubsub_node(
        self, cluster: RedisCluster, node: ClusterNode | None = ..., host: str | None = ..., port: int | None = ...
    ) -> None: ...
    def get_pubsub_node(self) -> ClusterNode | None: ...
    def execute_command(self, *args, **kwargs) -> None: ...
    def get_redis_connection(self) -> Redis | None: ...
...
class ClusterPipeline(RedisCluster[_StrType], Generic[_StrType]):
    ...
    scripts: set  # is only set in `reset()`
