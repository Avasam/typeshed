...
class Redis(AbstractRedis, RedisModuleCommands, AsyncCoreCommands[_StrType], AsyncSentinelCommands, Generic[_StrType]):
    ...
    async def transaction(
        self,
        func: Callable[[Pipeline[_StrType]], Any | Awaitable],
        *watches: KeyT,
        shard_hint: str | None = ...,
...
class PubSub:
    ...
    def ping(self, message: Any | None = ...) -> Awaitable: ...
...
class Pipeline(Redis[_StrType], Generic[_StrType]):
    ...
    def raise_first_error(self, commands: CommandStackT, response: Iterable): ...
