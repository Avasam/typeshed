...
import _win32typing
from win32.lib.pywintypes import OVERLAPPEDType, SECURITY_ATTRIBUTESType, error as error
...
def ConnectNamedPipe(hPipe: int, overlapped: OVERLAPPEDType | None = ..., /): ...
def TransactNamedPipe(
    pipeName, writeData: str, buffer_bufSize: _win32typing.PyOVERLAPPEDReadBuffer, overlapped: OVERLAPPEDType | None = ..., /
) -> str: ...
def CallNamedPipe(pipeName, data: str, bufSize, timeOut, /) -> str: ...
def CreatePipe(sa: SECURITY_ATTRIBUTESType, nSize: int, /) -> tuple[int, int]: ...
def FdCreatePipe(sa: SECURITY_ATTRIBUTESType, nSize, mode, /) -> tuple[Incomplete, Incomplete]: ...
def CreateNamedPipe(
    pipeName: str,
    openMode,
    pipeMode,
