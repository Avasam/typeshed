...
def NetUserGetLocalGroups(serverName: str, userName: str, flags) -> list: ...
...
def NetSessionEnum(level, server: str | None = ..., client: str | None = ..., username: str | None = ...) -> tuple: ...
...
def NetFileEnum(level, servername: str | None = ..., basepath: str | None = ..., username: str | None = ...) -> tuple: ...
