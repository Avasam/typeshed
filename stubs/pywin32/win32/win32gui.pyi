...
import _win32typing
from win32.lib.pywintypes import DEVMODEType, DEVMODEWType, HANDLEType, error as error
...
def CascadeWindows(
    hwndObject: HANDLEType | int | None,
    how: int,
    rectObject: _win32typing.PyRECT | tuple[int, int, int, int] | int | None = None,
    childrenObject: tuple[HANDLEType | int, ...] | None = None,
    /,
) -> int: ...
def SendMessage(
...
def ResetDC(hdc: int, devmode: DEVMODEType | DEVMODEWType, /) -> int: ...
...
def DeleteDC(hdc: int | HANDLEType, /) -> None: ...
def CreateCompatibleDC(dc: int | HANDLEType | None, /) -> int: ...
def CreateCompatibleBitmap(hdc: int | HANDLEType | None, width: int, height: int, /) -> _win32typing.PyGdiHANDLE: ...
def CreateBitmap(width: int, height: int, cPlanes: int, cBitsPerPixel: int, bitmap_bits: None, /) -> _win32typing.PyGdiHANDLE: ...
def SelectObject(hdc: int | HANDLEType | None, object: int | HANDLEType | None, /) -> int: ...
def GetCurrentObject(hdc: int, ObjectType, /) -> int: ...
def GetWindowRect(hwnd: int | HANDLEType, /) -> tuple[int, int, int, int]: ...
...
def SetParent(child: int, child1: int | HANDLEType | None, /) -> int: ...
def GetCursorPos() -> tuple[Incomplete, Incomplete]: ...
def GetDesktopWindow(): ...
def GetWindow(hWnd: int, uCmd: int, /) -> int: ...
def GetWindowDC(hWnd: int | HANDLEType | None, /) -> int: ...
...
def GetCapture(): ...
def SetCapture() -> None: ...
def ReleaseDC(hWnd: int | HANDLEType | None, hDC: int | HANDLEType | None, /) -> Literal[0, 1]: ...
...
def CreateDC(Driver: str, Device: str, InitData: DEVMODEType, /): ...
