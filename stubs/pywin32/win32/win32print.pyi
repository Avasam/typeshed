...
import _win32typing
from win32.lib.pywintypes import DEVMODEType
...
def DocumentProperties(
    ...
    DeviceName: str,
    DevModeOutput: DEVMODEType,
    DevModeInput: DEVMODEType,
    Mode,
    /,
): ...
...
def DeviceCapabilities(Device: str, Port: str, Capability, DEVMODE: DEVMODEType | None = ..., /) -> None: ...
