...
def CertEnumSystemStore(dwFlags, pvSystemStoreLocationPara: Incomplete | None = ...) -> list: ...
def CertEnumSystemStoreLocation(Flags: int = ...) -> list: ...
def CertEnumPhysicalStore(pvSystemStore: str, dwFlags) -> list: ...
...
def CryptSignMessage(SignPara: _win32typing.PyCRYPT_SIGN_MESSAGE_PARA, ToBeSigned: tuple, DetachedSignature: bool = ...): ...
def CryptVerifyDetachedMessageSignature(
    SignerIndex, DetachedSignBlob, ToBeSigned: tuple, VerifyPara: _win32typing.PyCRYPT_VERIFY_MESSAGE_PARA | None = ...
) -> _win32typing.PyCERT_CONTEXT: ...
