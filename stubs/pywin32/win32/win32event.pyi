...
from win32.lib.pywintypes import HANDLEType, SECURITY_ATTRIBUTESType, error as error

def CancelWaitableTimer() -> None: ...
def CreateEvent(
    EventAttributes: SECURITY_ATTRIBUTESType | None, bManualReset: int | bool, bInitialState: int | bool, Name: str | None, /
) -> int: ...
def CreateMutex(MutexAttributes: SECURITY_ATTRIBUTESType, InitialOwner, Name: str, /) -> int: ...
def CreateSemaphore(SemaphoreAttributes: SECURITY_ATTRIBUTESType, InitialCount, MaximumCount, SemaphoreName, /) -> int: ...
def CreateWaitableTimer(TimerAttributes: SECURITY_ATTRIBUTESType, ManualReset, TimerName, /) -> int: ...
def CreateWaitableTimerEx(
    lpTimerAttributes: SECURITY_ATTRIBUTESType | None, lpTimerName: str | None, dwFlags: int, dwDesiredAccess: int, /
) -> HANDLEType: ...
