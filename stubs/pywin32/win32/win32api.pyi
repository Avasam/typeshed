...
def ChangeDisplaySettings(DevMode: DEVMODEType, Flags, /): ...
def ChangeDisplaySettingsEx(DeviceName: str | None = ..., DevMode: DEVMODEType | None = ..., Flags=...) -> int: ...
...
def EnumDisplayDevices(Device: str | None = ..., DevNum: int = ..., Flags: int = ...) -> PyDISPLAY_DEVICEType: ...
def EnumDisplayMonitors(
    hdc: int | None = ..., rcClip: _win32typing.PyRECT | None = ...
) -> list[tuple[HANDLEType, HANDLEType, tuple[int, int, int, int]]]: ...
def EnumDisplaySettings(DeviceName: str | None = ..., ModeNum: int = ...) -> DEVMODEWType: ...
def EnumDisplaySettingsEx(DeviceName: str | None = ..., ModeNum=..., Flags=...) -> DEVMODEWType: ...
...
def GetStdHandle(handle: int, /) -> HANDLEType: ...
...
def RegGetKeySecurity(key: _win32typing.PyHKEY, security_info, /) -> SECURITY_DESCRIPTORType: ...
...
def RegSaveKey(key: _win32typing.PyHKEY, filename: str, sa: SECURITY_ATTRIBUTESType | None = ..., /) -> None: ...
def RegSaveKeyEx(
    Key: _win32typing.PyHKEY, File: str, SecurityAttributes: SECURITY_ATTRIBUTESType | None = ..., Flags=...
) -> None: ...
def RegSetKeySecurity(key: _win32typing.PyHKEY, security_info, sd: SECURITY_DESCRIPTORType, /) -> None: ...
...
class PyDISPLAY_DEVICEType:
    __name__: ClassVar[str] = "PyDISPLAY_DEVICE"
    @property
    def Size(self) -> int: ...
    @property
