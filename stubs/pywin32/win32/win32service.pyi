...
def EnumServicesStatus(hSCManager: _win32typing.PySC_HANDLE, ServiceType, ServiceState) -> tuple: ...
def EnumServicesStatusEx(
    SCManager: _win32typing.PySC_HANDLE, ServiceType, ServiceState, InfoLevel, GroupName: Incomplete | None = ...
) -> tuple: ...
def EnumDependentServices(hService: _win32typing.PySC_HANDLE, ServiceState) -> tuple: ...
