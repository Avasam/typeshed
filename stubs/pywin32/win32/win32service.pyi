...
import _win32typing
from win32.lib.pywintypes import SECURITY_ATTRIBUTESType, SECURITY_DESCRIPTORType, error as error

def GetThreadDesktop(ThreadId, /) -> HDESKType: ...
...
def OpenWindowStation(szWinSta, Inherit, DesiredAccess, /) -> HWINSTAType: ...
def OpenDesktop(szDesktop, Flags, Inherit, DesiredAccess, /) -> HDESKType: ...
def CreateDesktop(Desktop, Flags, DesiredAccess, SecurityAttributes: SECURITY_ATTRIBUTESType, /) -> HDESKType: ...
def OpenInputDesktop(Flags, Inherit, DesiredAccess, /) -> HDESKType: ...
def GetProcessWindowStation() -> HWINSTAType: ...
def CreateWindowStation(WindowStation, Flags, DesiredAccess, SecurityAttributes: SECURITY_ATTRIBUTESType, /) -> HWINSTAType: ...
...
def SetServiceObjectSecurity(
    Handle: _win32typing.PySC_HANDLE, SecurityInformation, SecurityDescriptor: SECURITY_DESCRIPTORType, /
) -> None: ...
def QueryServiceObjectSecurity(Handle: _win32typing.PySC_HANDLE, SecurityInformation, /) -> SECURITY_DESCRIPTORType: ...
...
@final
class HWINSTAType:
    __name__: ClassVar[str] = "PyHWINSTA"
    def __init__(self, handle) -> None: ...
