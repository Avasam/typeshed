...
def DsCrackNames(
    hds: _win32typing.PyDS_HANDLE, flags, formatOffered, formatDesired, names: list
...
def LsaAddAccountRights(PolicyHandle: _win32typing.PyLSA_HANDLE, AccountSid: _win32typing.PySID, UserRights: tuple) -> None: ...
def LsaRemoveAccountRights(
    PolicyHandle: _win32typing.PyLSA_HANDLE, AccountSid: _win32typing.PySID, AllRights, UserRights: tuple
) -> None: ...
...
def EnumerateSecurityPackages() -> tuple: ...
...
def LsaEnumerateLogonSessions() -> tuple: ...
def LsaGetLogonSessionData(LogonId) -> tuple: ...
