...
def PackTVINSERTSTRUCT(parent, insertAfter, tvitem) -> tuple[bytes, list]: ...
def PackTVITEM(hitem, state, stateMask, text, image, selimage, citems, param) -> tuple[array[int], list]: ...
def EmptyTVITEM(hitem, mask: Incomplete | None = ..., text_buf_size: int = ...) -> tuple[array[int], list]: ...
...
def EmptyLVITEM(item, subitem, mask: Incomplete | None = ..., text_buf_size: int = ...) -> tuple[array[int], list]: ...
def PackLVCOLUMN(
    fmt: Incomplete | None = ...,
    cx: Incomplete | None = ...,
    text: Incomplete | None = ...,
...
def EmptyLVCOLUMN(mask: Incomplete | None = ..., text_buf_size: int = ...) -> tuple[array[int], list]: ...
