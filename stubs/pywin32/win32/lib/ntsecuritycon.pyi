...
FILE_ALL_ACCESS: Incomplete
FILE_GENERIC_READ: Incomplete
FILE_GENERIC_WRITE: Incomplete
FILE_GENERIC_EXECUTE: Incomplete
SECURITY_NULL_SID_AUTHORITY: Incomplete
SECURITY_WORLD_SID_AUTHORITY: Incomplete
SECURITY_LOCAL_SID_AUTHORITY: Incomplete
SECURITY_CREATOR_SID_AUTHORITY: Incomplete
SECURITY_NON_UNIQUE_AUTHORITY: Incomplete
SECURITY_RESOURCE_MANAGER_AUTHORITY: Incomplete
...
SECURITY_NT_AUTHORITY: Incomplete
...
SECURITY_MANDATORY_LABEL_AUTHORITY: Incomplete
...
SYSTEM_LUID: Incomplete
ANONYMOUS_LOGON_LUID: Incomplete
LOCALSERVICE_LUID: Incomplete
NETWORKSERVICE_LUID: Incomplete
IUSER_LUID: Incomplete
...
NTDSDSA_OPT_IS_GC: Incomplete
NTDSDSA_OPT_DISABLE_INBOUND_REPL: Incomplete
NTDSDSA_OPT_DISABLE_OUTBOUND_REPL: Incomplete
NTDSDSA_OPT_DISABLE_NTDSCONN_XLATE: Incomplete
NTDSCONN_OPT_IS_GENERATED: Incomplete
NTDSCONN_OPT_TWOWAY_SYNC: Incomplete
NTDSCONN_OPT_OVERRIDE_NOTIFY_DEFAULT: Incomplete
NTDSCONN_OPT_USE_NOTIFY: Incomplete
NTDSCONN_OPT_DISABLE_INTERSITE_COMPRESSION: Incomplete
NTDSCONN_OPT_USER_OWNED_SCHEDULE: Incomplete
NTDSCONN_KCC_NO_REASON: int
NTDSCONN_KCC_GC_TOPOLOGY: Incomplete
NTDSCONN_KCC_RING_TOPOLOGY: Incomplete
NTDSCONN_KCC_MINIMIZE_HOPS_TOPOLOGY: Incomplete
NTDSCONN_KCC_STALE_SERVERS_TOPOLOGY: Incomplete
NTDSCONN_KCC_OSCILLATING_CONNECTION_TOPOLOGY: Incomplete
NTDSCONN_KCC_INTERSITE_GC_TOPOLOGY: Incomplete
NTDSCONN_KCC_INTERSITE_TOPOLOGY: Incomplete
NTDSCONN_KCC_SERVER_FAILOVER_TOPOLOGY: Incomplete
NTDSCONN_KCC_SITE_FAILOVER_TOPOLOGY: Incomplete
NTDSCONN_KCC_REDUNDANT_SERVER_TOPOLOGY: Incomplete
FRSCONN_PRIORITY_MASK: int
FRSCONN_MAX_PRIORITY: int
NTDSCONN_OPT_IGNORE_SCHEDULE_MASK: int
NTDSSETTINGS_OPT_IS_AUTO_TOPOLOGY_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_TOPL_CLEANUP_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_TOPL_MIN_HOPS_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_TOPL_DETECT_STALE_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_INTER_SITE_AUTO_TOPOLOGY_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_GROUP_CACHING_ENABLED: Incomplete
NTDSSETTINGS_OPT_FORCE_KCC_WHISTLER_BEHAVIOR: Incomplete
NTDSSETTINGS_OPT_FORCE_KCC_W2K_ELECTION: Incomplete
NTDSSETTINGS_OPT_IS_RAND_BH_SELECTION_DISABLED: Incomplete
NTDSSETTINGS_OPT_IS_SCHEDULE_HASHING_ENABLED: Incomplete
NTDSSETTINGS_OPT_IS_REDUNDANT_SERVER_TOPOLOGY_ENABLED: Incomplete
NTDSSETTINGS_DEFAULT_SERVER_REDUNDANCY: int
NTDSTRANSPORT_OPT_IGNORE_SCHEDULES: Incomplete
NTDSTRANSPORT_OPT_BRIDGES_REQUIRED: Incomplete
NTDSSITECONN_OPT_USE_NOTIFY: Incomplete
NTDSSITECONN_OPT_TWOWAY_SYNC: Incomplete
NTDSSITECONN_OPT_DISABLE_COMPRESSION: Incomplete
NTDSSITELINK_OPT_USE_NOTIFY: Incomplete
NTDSSITELINK_OPT_TWOWAY_SYNC: Incomplete
NTDSSITELINK_OPT_DISABLE_COMPRESSION: Incomplete
...
DS_KCC_FLAG_ASYNC_OP: Incomplete
DS_KCC_FLAG_DAMPED: Incomplete
...
DS_REPL_NBR_MODIFIABLE_MASK: Incomplete
DS_UNKNOWN_NAME: int
...
DSGETDC_VALID_FLAGS: Incomplete
DS_INET_ADDRESS: int
