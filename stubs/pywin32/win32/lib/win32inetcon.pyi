...
SECURITY_INTERNET_MASK: Incomplete
...
GOPHER_TYPE_FILE_MASK: Incomplete
MAX_GOPHER_CATEGORY_NAME: int
MAX_GOPHER_ATTRIBUTE_NAME: int
MIN_GOPHER_ATTRIBUTE_LENGTH: int
GOPHER_ATTRIBUTE_ID_BASE: int
GOPHER_CATEGORY_ID_ALL: Incomplete
GOPHER_CATEGORY_ID_INFO: Incomplete
GOPHER_CATEGORY_ID_ADMIN: Incomplete
GOPHER_CATEGORY_ID_VIEWS: Incomplete
GOPHER_CATEGORY_ID_ABSTRACT: Incomplete
GOPHER_CATEGORY_ID_VERONICA: Incomplete
GOPHER_CATEGORY_ID_ASK: Incomplete
GOPHER_CATEGORY_ID_UNKNOWN: Incomplete
GOPHER_ATTRIBUTE_ID_ALL: Incomplete
GOPHER_ATTRIBUTE_ID_ADMIN: Incomplete
GOPHER_ATTRIBUTE_ID_MOD_DATE: Incomplete
GOPHER_ATTRIBUTE_ID_TTL: Incomplete
GOPHER_ATTRIBUTE_ID_SCORE: Incomplete
GOPHER_ATTRIBUTE_ID_RANGE: Incomplete
GOPHER_ATTRIBUTE_ID_SITE: Incomplete
GOPHER_ATTRIBUTE_ID_ORG: Incomplete
GOPHER_ATTRIBUTE_ID_LOCATION: Incomplete
GOPHER_ATTRIBUTE_ID_GEOG: Incomplete
GOPHER_ATTRIBUTE_ID_TIMEZONE: Incomplete
GOPHER_ATTRIBUTE_ID_PROVIDER: Incomplete
GOPHER_ATTRIBUTE_ID_VERSION: Incomplete
GOPHER_ATTRIBUTE_ID_ABSTRACT: Incomplete
GOPHER_ATTRIBUTE_ID_VIEW: Incomplete
GOPHER_ATTRIBUTE_ID_TREEWALK: Incomplete
GOPHER_ATTRIBUTE_ID_UNKNOWN: Incomplete
...
HTTP_QUERY_MODIFIER_FLAGS_MASK: Incomplete
HTTP_QUERY_HEADER_MASK: Incomplete
...
ERROR_INTERNET_OUT_OF_HANDLES: Incomplete
ERROR_INTERNET_TIMEOUT: Incomplete
ERROR_INTERNET_EXTENDED_ERROR: Incomplete
ERROR_INTERNET_INTERNAL_ERROR: Incomplete
ERROR_INTERNET_INVALID_URL: Incomplete
ERROR_INTERNET_UNRECOGNIZED_SCHEME: Incomplete
ERROR_INTERNET_NAME_NOT_RESOLVED: Incomplete
ERROR_INTERNET_PROTOCOL_NOT_FOUND: Incomplete
ERROR_INTERNET_INVALID_OPTION: Incomplete
ERROR_INTERNET_BAD_OPTION_LENGTH: Incomplete
ERROR_INTERNET_OPTION_NOT_SETTABLE: Incomplete
ERROR_INTERNET_SHUTDOWN: Incomplete
ERROR_INTERNET_INCORRECT_USER_NAME: Incomplete
ERROR_INTERNET_INCORRECT_PASSWORD: Incomplete
ERROR_INTERNET_LOGIN_FAILURE: Incomplete
ERROR_INTERNET_INVALID_OPERATION: Incomplete
ERROR_INTERNET_OPERATION_CANCELLED: Incomplete
ERROR_INTERNET_INCORRECT_HANDLE_TYPE: Incomplete
ERROR_INTERNET_INCORRECT_HANDLE_STATE: Incomplete
ERROR_INTERNET_NOT_PROXY_REQUEST: Incomplete
ERROR_INTERNET_REGISTRY_VALUE_NOT_FOUND: Incomplete
ERROR_INTERNET_BAD_REGISTRY_PARAMETER: Incomplete
ERROR_INTERNET_NO_DIRECT_ACCESS: Incomplete
ERROR_INTERNET_NO_CONTEXT: Incomplete
ERROR_INTERNET_NO_CALLBACK: Incomplete
ERROR_INTERNET_REQUEST_PENDING: Incomplete
ERROR_INTERNET_INCORRECT_FORMAT: Incomplete
ERROR_INTERNET_ITEM_NOT_FOUND: Incomplete
ERROR_INTERNET_CANNOT_CONNECT: Incomplete
ERROR_INTERNET_CONNECTION_ABORTED: Incomplete
ERROR_INTERNET_CONNECTION_RESET: Incomplete
ERROR_INTERNET_FORCE_RETRY: Incomplete
ERROR_INTERNET_INVALID_PROXY_REQUEST: Incomplete
ERROR_INTERNET_NEED_UI: Incomplete
ERROR_INTERNET_HANDLE_EXISTS: Incomplete
ERROR_INTERNET_SEC_CERT_DATE_INVALID: Incomplete
ERROR_INTERNET_SEC_CERT_CN_INVALID: Incomplete
ERROR_INTERNET_HTTP_TO_HTTPS_ON_REDIR: Incomplete
ERROR_INTERNET_HTTPS_TO_HTTP_ON_REDIR: Incomplete
ERROR_INTERNET_MIXED_SECURITY: Incomplete
ERROR_INTERNET_CHG_POST_IS_NON_SECURE: Incomplete
ERROR_INTERNET_POST_IS_NON_SECURE: Incomplete
ERROR_INTERNET_CLIENT_AUTH_CERT_NEEDED: Incomplete
ERROR_INTERNET_INVALID_CA: Incomplete
ERROR_INTERNET_CLIENT_AUTH_NOT_SETUP: Incomplete
ERROR_INTERNET_ASYNC_THREAD_FAILED: Incomplete
ERROR_INTERNET_REDIRECT_SCHEME_CHANGE: Incomplete
ERROR_INTERNET_DIALOG_PENDING: Incomplete
ERROR_INTERNET_RETRY_DIALOG: Incomplete
ERROR_INTERNET_HTTPS_HTTP_SUBMIT_REDIR: Incomplete
ERROR_INTERNET_INSERT_CDROM: Incomplete
ERROR_INTERNET_FORTEZZA_LOGIN_NEEDED: Incomplete
ERROR_INTERNET_SEC_CERT_ERRORS: Incomplete
ERROR_INTERNET_SEC_CERT_NO_REV: Incomplete
ERROR_INTERNET_SEC_CERT_REV_FAILED: Incomplete
ERROR_FTP_TRANSFER_IN_PROGRESS: Incomplete
ERROR_FTP_DROPPED: Incomplete
ERROR_FTP_NO_PASSIVE_MODE: Incomplete
ERROR_GOPHER_PROTOCOL_ERROR: Incomplete
ERROR_GOPHER_NOT_FILE: Incomplete
ERROR_GOPHER_DATA_ERROR: Incomplete
ERROR_GOPHER_END_OF_DATA: Incomplete
ERROR_GOPHER_INVALID_LOCATOR: Incomplete
ERROR_GOPHER_INCORRECT_LOCATOR_TYPE: Incomplete
ERROR_GOPHER_NOT_GOPHER_PLUS: Incomplete
ERROR_GOPHER_ATTRIBUTE_NOT_FOUND: Incomplete
ERROR_GOPHER_UNKNOWN_LOCATOR: Incomplete
ERROR_HTTP_HEADER_NOT_FOUND: Incomplete
ERROR_HTTP_DOWNLEVEL_SERVER: Incomplete
ERROR_HTTP_INVALID_SERVER_RESPONSE: Incomplete
ERROR_HTTP_INVALID_HEADER: Incomplete
ERROR_HTTP_INVALID_QUERY_REQUEST: Incomplete
ERROR_HTTP_HEADER_ALREADY_EXISTS: Incomplete
ERROR_HTTP_REDIRECT_FAILED: Incomplete
ERROR_HTTP_NOT_REDIRECTED: Incomplete
ERROR_HTTP_COOKIE_NEEDS_CONFIRMATION: Incomplete
ERROR_HTTP_COOKIE_DECLINED: Incomplete
ERROR_HTTP_REDIRECT_NEEDS_CONFIRMATION: Incomplete
ERROR_INTERNET_SECURITY_CHANNEL_ERROR: Incomplete
ERROR_INTERNET_UNABLE_TO_CACHE_FILE: Incomplete
ERROR_INTERNET_TCPIP_NOT_INSTALLED: Incomplete
ERROR_INTERNET_DISCONNECTED: Incomplete
ERROR_INTERNET_SERVER_UNREACHABLE: Incomplete
ERROR_INTERNET_PROXY_SERVER_UNREACHABLE: Incomplete
ERROR_INTERNET_BAD_AUTO_PROXY_SCRIPT: Incomplete
ERROR_INTERNET_UNABLE_TO_DOWNLOAD_SCRIPT: Incomplete
ERROR_INTERNET_SEC_INVALID_CERT: Incomplete
ERROR_INTERNET_SEC_CERT_REVOKED: Incomplete
ERROR_INTERNET_FAILED_DUETOSECURITYCHECK: Incomplete
ERROR_INTERNET_NOT_INITIALIZED: Incomplete
ERROR_INTERNET_NEED_MSN_SSPI_PKG: Incomplete
ERROR_INTERNET_LOGIN_FAILURE_DISPLAY_ENTITY_BODY: Incomplete
INTERNET_ERROR_LAST: Incomplete
...
URLCACHE_FIND_DEFAULT_FILTER: Incomplete
...
CACHEGROUP_READWRITE_MASK: Incomplete
...
INTERNET_AUTODIAL_FLAGS_MASK: Incomplete
...
WINHTTP_FLAG_SECURE_PROTOCOL_ALL: Incomplete
...
WINHTTP_CALLBACK_FLAG_RESOLVE_NAME: Incomplete
WINHTTP_CALLBACK_FLAG_CONNECT_TO_SERVER: Incomplete
WINHTTP_CALLBACK_FLAG_SEND_REQUEST: Incomplete
WINHTTP_CALLBACK_FLAG_RECEIVE_RESPONSE: Incomplete
WINHTTP_CALLBACK_FLAG_CLOSE_CONNECTION: Incomplete
WINHTTP_CALLBACK_FLAG_HANDLES: Incomplete
...
WINHTTP_CALLBACK_FLAG_ALL_COMPLETIONS: Incomplete
...
ERROR_WINHTTP_OUT_OF_HANDLES: Incomplete
ERROR_WINHTTP_TIMEOUT: Incomplete
ERROR_WINHTTP_INTERNAL_ERROR: Incomplete
ERROR_WINHTTP_INVALID_URL: Incomplete
ERROR_WINHTTP_UNRECOGNIZED_SCHEME: Incomplete
ERROR_WINHTTP_NAME_NOT_RESOLVED: Incomplete
ERROR_WINHTTP_INVALID_OPTION: Incomplete
ERROR_WINHTTP_OPTION_NOT_SETTABLE: Incomplete
ERROR_WINHTTP_SHUTDOWN: Incomplete
ERROR_WINHTTP_LOGIN_FAILURE: Incomplete
ERROR_WINHTTP_OPERATION_CANCELLED: Incomplete
ERROR_WINHTTP_INCORRECT_HANDLE_TYPE: Incomplete
ERROR_WINHTTP_INCORRECT_HANDLE_STATE: Incomplete
ERROR_WINHTTP_CANNOT_CONNECT: Incomplete
ERROR_WINHTTP_CONNECTION_ERROR: Incomplete
ERROR_WINHTTP_RESEND_REQUEST: Incomplete
ERROR_WINHTTP_CLIENT_AUTH_CERT_NEEDED: Incomplete
ERROR_WINHTTP_CANNOT_CALL_BEFORE_OPEN: Incomplete
ERROR_WINHTTP_CANNOT_CALL_BEFORE_SEND: Incomplete
ERROR_WINHTTP_CANNOT_CALL_AFTER_SEND: Incomplete
ERROR_WINHTTP_CANNOT_CALL_AFTER_OPEN: Incomplete
ERROR_WINHTTP_HEADER_NOT_FOUND: Incomplete
ERROR_WINHTTP_INVALID_SERVER_RESPONSE: Incomplete
ERROR_WINHTTP_INVALID_HEADER: Incomplete
ERROR_WINHTTP_INVALID_QUERY_REQUEST: Incomplete
ERROR_WINHTTP_HEADER_ALREADY_EXISTS: Incomplete
ERROR_WINHTTP_REDIRECT_FAILED: Incomplete
ERROR_WINHTTP_AUTO_PROXY_SERVICE_ERROR: Incomplete
ERROR_WINHTTP_BAD_AUTO_PROXY_SCRIPT: Incomplete
ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT: Incomplete
ERROR_WINHTTP_NOT_INITIALIZED: Incomplete
ERROR_WINHTTP_SECURE_FAILURE: Incomplete
ERROR_WINHTTP_SECURE_CERT_DATE_INVALID: Incomplete
ERROR_WINHTTP_SECURE_CERT_CN_INVALID: Incomplete
ERROR_WINHTTP_SECURE_INVALID_CA: Incomplete
ERROR_WINHTTP_SECURE_CERT_REV_FAILED: Incomplete
ERROR_WINHTTP_SECURE_CHANNEL_ERROR: Incomplete
ERROR_WINHTTP_SECURE_INVALID_CERT: Incomplete
ERROR_WINHTTP_SECURE_CERT_REVOKED: Incomplete
ERROR_WINHTTP_SECURE_CERT_WRONG_USAGE: Incomplete
ERROR_WINHTTP_AUTODETECTION_FAILED: Incomplete
ERROR_WINHTTP_HEADER_COUNT_EXCEEDED: Incomplete
ERROR_WINHTTP_HEADER_SIZE_OVERFLOW: Incomplete
ERROR_WINHTTP_CHUNKED_ENCODING_HEADER_SIZE_OVERFLOW: Incomplete
ERROR_WINHTTP_RESPONSE_DRAIN_OVERFLOW: Incomplete
ERROR_WINHTTP_CLIENT_CERT_NO_PRIVATE_KEY: Incomplete
ERROR_WINHTTP_CLIENT_CERT_NO_ACCESS_PRIVATE_KEY: Incomplete
WINHTTP_ERROR_LAST: Incomplete
WINHTTP_NO_PROXY_NAME: Incomplete
WINHTTP_NO_PROXY_BYPASS: Incomplete
WINHTTP_NO_REFERER: Incomplete
WINHTTP_DEFAULT_ACCEPT_TYPES: Incomplete
WINHTTP_NO_ADDITIONAL_HEADERS: Incomplete
WINHTTP_NO_REQUEST_DATA: Incomplete
