...
LM20_DNLEN: int
UNCLEN: Incomplete
LM20_UNCLEN: Incomplete
NNLEN: int
LM20_NNLEN: int
RMLEN: Incomplete
LM20_RMLEN: Incomplete
SNLEN: int
LM20_SNLEN: int
STXTLEN: int
LM20_STXTLEN: int
...
UF_MACHINE_ACCOUNT_MASK: Incomplete
UF_ACCOUNT_TYPE_MASK: Incomplete
UF_DONT_EXPIRE_PASSWD: int
UF_MNS_LOGON_ACCOUNT: int
UF_SETTABLE_BITS: Incomplete
...
USER_NAME_INFOLEVEL: Incomplete
USER_PASSWORD_INFOLEVEL: Incomplete
USER_PASSWORD_AGE_INFOLEVEL: Incomplete
USER_PRIV_INFOLEVEL: Incomplete
USER_HOME_DIR_INFOLEVEL: Incomplete
USER_COMMENT_INFOLEVEL: Incomplete
USER_FLAGS_INFOLEVEL: Incomplete
USER_SCRIPT_PATH_INFOLEVEL: Incomplete
USER_AUTH_FLAGS_INFOLEVEL: Incomplete
USER_FULL_NAME_INFOLEVEL: Incomplete
USER_USR_COMMENT_INFOLEVEL: Incomplete
USER_PARMS_INFOLEVEL: Incomplete
USER_WORKSTATIONS_INFOLEVEL: Incomplete
USER_LAST_LOGON_INFOLEVEL: Incomplete
USER_LAST_LOGOFF_INFOLEVEL: Incomplete
USER_ACCT_EXPIRES_INFOLEVEL: Incomplete
USER_MAX_STORAGE_INFOLEVEL: Incomplete
USER_UNITS_PER_WEEK_INFOLEVEL: Incomplete
USER_LOGON_HOURS_INFOLEVEL: Incomplete
USER_PAD_PW_COUNT_INFOLEVEL: Incomplete
USER_NUM_LOGONS_INFOLEVEL: Incomplete
USER_LOGON_SERVER_INFOLEVEL: Incomplete
USER_COUNTRY_CODE_INFOLEVEL: Incomplete
USER_CODE_PAGE_INFOLEVEL: Incomplete
USER_PRIMARY_GROUP_INFOLEVEL: Incomplete
USER_HOME_DIR_DRIVE_INFOLEVEL: Incomplete
NULL_USERSETINFO_PASSWD: str
UNITS_PER_DAY: int
UNITS_PER_WEEK: Incomplete
USER_PRIV_MASK: int
USER_PRIV_GUEST: int
USER_PRIV_USER: int
USER_PRIV_ADMIN: int
...
MODALS_MIN_PASSWD_LEN_INFOLEVEL: Incomplete
MODALS_MAX_PASSWD_AGE_INFOLEVEL: Incomplete
MODALS_MIN_PASSWD_AGE_INFOLEVEL: Incomplete
MODALS_FORCE_LOGOFF_INFOLEVEL: Incomplete
MODALS_PASSWD_HIST_LEN_INFOLEVEL: Incomplete
MODALS_ROLE_INFOLEVEL: Incomplete
MODALS_PRIMARY_INFOLEVEL: Incomplete
MODALS_DOMAIN_NAME_INFOLEVEL: Incomplete
MODALS_DOMAIN_ID_INFOLEVEL: Incomplete
GROUPIDMASK: int
GROUP_ALL_PARMNUM: int
GROUP_NAME_PARMNUM: int
GROUP_COMMENT_PARMNUM: int
GROUP_ATTRIBUTES_PARMNUM: int
GROUP_ALL_INFOLEVEL: Incomplete
GROUP_NAME_INFOLEVEL: Incomplete
GROUP_COMMENT_INFOLEVEL: Incomplete
GROUP_ATTRIBUTES_INFOLEVEL: Incomplete
...
ACCESS_RESOURCE_NAME_INFOLEVEL: Incomplete
ACCESS_ATTR_INFOLEVEL: Incomplete
ACCESS_COUNT_INFOLEVEL: Incomplete
ACCESS_ACCESS_LIST_INFOLEVEL: Incomplete
ACCESS_LETTERS: str
...
MESSAGE_FILENAME: Incomplete
OS2MSG_FILENAME: Incomplete
HELP_MSG_FILENAME: Incomplete
BACKUP_MSG_FILENAME: Incomplete
TIMEQ_FOREVER: int
...
SHI1005_VALID_FLAGS_SET: Incomplete
SHI1007_VALID_FLAGS_SET: Incomplete
SESS_GUEST: int
