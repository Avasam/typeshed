...
from win32.lib.ntsecuritycon import FILE_READ_DATA as FILE_READ_DATA, FILE_WRITE_DATA as FILE_WRITE_DATA
...
WMI_DISK_GEOMETRY_GUID: Incomplete
GUID_DEVINTERFACE_CDROM: Incomplete
GUID_DEVINTERFACE_FLOPPY: Incomplete
GUID_DEVINTERFACE_SERENUM_BUS_ENUMERATOR: Incomplete
GUID_DEVINTERFACE_COMPORT: Incomplete
GUID_DEVINTERFACE_DISK: Incomplete
GUID_DEVINTERFACE_STORAGEPORT: Incomplete
GUID_DEVINTERFACE_CDCHANGER: Incomplete
GUID_DEVINTERFACE_PARTITION: Incomplete
GUID_DEVINTERFACE_VOLUME: Incomplete
GUID_DEVINTERFACE_WRITEONCEDISK: Incomplete
GUID_DEVINTERFACE_TAPE: Incomplete
GUID_DEVINTERFACE_MEDIUMCHANGER: Incomplete
GUID_SERENUM_BUS_ENUMERATOR: Incomplete
GUID_CLASS_COMPORT: Incomplete
DiskClassGuid: Incomplete
CdRomClassGuid: Incomplete
PartitionClassGuid: Incomplete
TapeClassGuid: Incomplete
WriteOnceDiskClassGuid: Incomplete
VolumeClassGuid: Incomplete
MediumChangerClassGuid: Incomplete
FloppyClassGuid: Incomplete
CdChangerClassGuid: Incomplete
StoragePortClassGuid: Incomplete
IOCTL_STORAGE_CHECK_VERIFY: Incomplete
IOCTL_STORAGE_CHECK_VERIFY2: Incomplete
IOCTL_STORAGE_MEDIA_REMOVAL: Incomplete
IOCTL_STORAGE_EJECT_MEDIA: Incomplete
IOCTL_STORAGE_LOAD_MEDIA: Incomplete
IOCTL_STORAGE_LOAD_MEDIA2: Incomplete
IOCTL_STORAGE_RESERVE: Incomplete
IOCTL_STORAGE_RELEASE: Incomplete
IOCTL_STORAGE_FIND_NEW_DEVICES: Incomplete
IOCTL_STORAGE_EJECTION_CONTROL: Incomplete
IOCTL_STORAGE_MCN_CONTROL: Incomplete
IOCTL_STORAGE_GET_MEDIA_TYPES: Incomplete
IOCTL_STORAGE_GET_MEDIA_TYPES_EX: Incomplete
IOCTL_STORAGE_GET_MEDIA_SERIAL_NUMBER: Incomplete
IOCTL_STORAGE_GET_HOTPLUG_INFO: Incomplete
IOCTL_STORAGE_SET_HOTPLUG_INFO: Incomplete
IOCTL_STORAGE_RESET_BUS: Incomplete
IOCTL_STORAGE_RESET_DEVICE: Incomplete
IOCTL_STORAGE_BREAK_RESERVATION: Incomplete
IOCTL_STORAGE_GET_DEVICE_NUMBER: Incomplete
IOCTL_STORAGE_PREDICT_FAILURE: Incomplete
IOCTL_DISK_GET_DRIVE_GEOMETRY: Incomplete
IOCTL_DISK_GET_PARTITION_INFO: Incomplete
IOCTL_DISK_SET_PARTITION_INFO: Incomplete
IOCTL_DISK_GET_DRIVE_LAYOUT: Incomplete
IOCTL_DISK_SET_DRIVE_LAYOUT: Incomplete
IOCTL_DISK_VERIFY: Incomplete
IOCTL_DISK_FORMAT_TRACKS: Incomplete
IOCTL_DISK_REASSIGN_BLOCKS: Incomplete
IOCTL_DISK_PERFORMANCE: Incomplete
IOCTL_DISK_IS_WRITABLE: Incomplete
IOCTL_DISK_LOGGING: Incomplete
IOCTL_DISK_FORMAT_TRACKS_EX: Incomplete
IOCTL_DISK_HISTOGRAM_STRUCTURE: Incomplete
IOCTL_DISK_HISTOGRAM_DATA: Incomplete
IOCTL_DISK_HISTOGRAM_RESET: Incomplete
IOCTL_DISK_REQUEST_STRUCTURE: Incomplete
IOCTL_DISK_REQUEST_DATA: Incomplete
IOCTL_DISK_PERFORMANCE_OFF: Incomplete
IOCTL_DISK_CONTROLLER_NUMBER: Incomplete
SMART_GET_VERSION: Incomplete
SMART_SEND_DRIVE_COMMAND: Incomplete
SMART_RCV_DRIVE_DATA: Incomplete
IOCTL_DISK_GET_PARTITION_INFO_EX: Incomplete
IOCTL_DISK_SET_PARTITION_INFO_EX: Incomplete
IOCTL_DISK_GET_DRIVE_LAYOUT_EX: Incomplete
IOCTL_DISK_SET_DRIVE_LAYOUT_EX: Incomplete
IOCTL_DISK_CREATE_DISK: Incomplete
IOCTL_DISK_GET_LENGTH_INFO: Incomplete
IOCTL_DISK_GET_DRIVE_GEOMETRY_EX: Incomplete
IOCTL_DISK_REASSIGN_BLOCKS_EX: Incomplete
IOCTL_DISK_UPDATE_DRIVE_SIZE: Incomplete
IOCTL_DISK_GROW_PARTITION: Incomplete
IOCTL_DISK_GET_CACHE_INFORMATION: Incomplete
IOCTL_DISK_SET_CACHE_INFORMATION: Incomplete
OBSOLETE_IOCTL_STORAGE_RESET_BUS: Incomplete
OBSOLETE_IOCTL_STORAGE_RESET_DEVICE: Incomplete
OBSOLETE_DISK_GET_WRITE_CACHE_STATE: Incomplete
IOCTL_DISK_GET_WRITE_CACHE_STATE: Incomplete
IOCTL_DISK_DELETE_DRIVE_LAYOUT: Incomplete
IOCTL_DISK_UPDATE_PROPERTIES: Incomplete
IOCTL_DISK_FORMAT_DRIVE: Incomplete
IOCTL_DISK_SENSE_DEVICE: Incomplete
IOCTL_DISK_CHECK_VERIFY: Incomplete
IOCTL_DISK_MEDIA_REMOVAL: Incomplete
IOCTL_DISK_EJECT_MEDIA: Incomplete
IOCTL_DISK_LOAD_MEDIA: Incomplete
IOCTL_DISK_RESERVE: Incomplete
IOCTL_DISK_RELEASE: Incomplete
IOCTL_DISK_FIND_NEW_DEVICES: Incomplete
IOCTL_DISK_GET_MEDIA_TYPES: Incomplete
DISK_HISTOGRAM_SIZE: int
HISTOGRAM_BUCKET_SIZE: int
IOCTL_CHANGER_GET_PARAMETERS: Incomplete
IOCTL_CHANGER_GET_STATUS: Incomplete
IOCTL_CHANGER_GET_PRODUCT_DATA: Incomplete
IOCTL_CHANGER_SET_ACCESS: Incomplete
IOCTL_CHANGER_GET_ELEMENT_STATUS: Incomplete
IOCTL_CHANGER_INITIALIZE_ELEMENT_STATUS: Incomplete
IOCTL_CHANGER_SET_POSITION: Incomplete
IOCTL_CHANGER_EXCHANGE_MEDIUM: Incomplete
IOCTL_CHANGER_MOVE_MEDIUM: Incomplete
IOCTL_CHANGER_REINITIALIZE_TRANSPORT: Incomplete
IOCTL_CHANGER_QUERY_VOLUME_TAGS: Incomplete
IOCTL_SERIAL_LSRMST_INSERT: Incomplete
IOCTL_SERENUM_EXPOSE_HARDWARE: Incomplete
IOCTL_SERENUM_REMOVE_HARDWARE: Incomplete
IOCTL_SERENUM_PORT_DESC: Incomplete
IOCTL_SERENUM_GET_PORT_NAME: Incomplete
...
FSCTL_REQUEST_OPLOCK_LEVEL_1: Incomplete
FSCTL_REQUEST_OPLOCK_LEVEL_2: Incomplete
FSCTL_REQUEST_BATCH_OPLOCK: Incomplete
FSCTL_OPLOCK_BREAK_ACKNOWLEDGE: Incomplete
FSCTL_OPBATCH_ACK_CLOSE_PENDING: Incomplete
FSCTL_OPLOCK_BREAK_NOTIFY: Incomplete
FSCTL_LOCK_VOLUME: Incomplete
FSCTL_UNLOCK_VOLUME: Incomplete
FSCTL_DISMOUNT_VOLUME: Incomplete
FSCTL_IS_VOLUME_MOUNTED: Incomplete
FSCTL_IS_PATHNAME_VALID: Incomplete
FSCTL_MARK_VOLUME_DIRTY: Incomplete
FSCTL_QUERY_RETRIEVAL_POINTERS: Incomplete
FSCTL_GET_COMPRESSION: Incomplete
FSCTL_SET_COMPRESSION: Incomplete
FSCTL_MARK_AS_SYSTEM_HIVE: Incomplete
FSCTL_OPLOCK_BREAK_ACK_NO_2: Incomplete
FSCTL_INVALIDATE_VOLUMES: Incomplete
FSCTL_QUERY_FAT_BPB: Incomplete
FSCTL_REQUEST_FILTER_OPLOCK: Incomplete
FSCTL_FILESYSTEM_GET_STATISTICS: Incomplete
FSCTL_GET_NTFS_VOLUME_DATA: Incomplete
FSCTL_GET_NTFS_FILE_RECORD: Incomplete
FSCTL_GET_VOLUME_BITMAP: Incomplete
FSCTL_GET_RETRIEVAL_POINTERS: Incomplete
FSCTL_MOVE_FILE: Incomplete
FSCTL_IS_VOLUME_DIRTY: Incomplete
FSCTL_ALLOW_EXTENDED_DASD_IO: Incomplete
FSCTL_FIND_FILES_BY_SID: Incomplete
FSCTL_SET_OBJECT_ID: Incomplete
FSCTL_GET_OBJECT_ID: Incomplete
FSCTL_DELETE_OBJECT_ID: Incomplete
FSCTL_SET_REPARSE_POINT: Incomplete
FSCTL_GET_REPARSE_POINT: Incomplete
FSCTL_DELETE_REPARSE_POINT: Incomplete
FSCTL_ENUM_USN_DATA: Incomplete
FSCTL_SECURITY_ID_CHECK: Incomplete
FSCTL_READ_USN_JOURNAL: Incomplete
FSCTL_SET_OBJECT_ID_EXTENDED: Incomplete
FSCTL_CREATE_OR_GET_OBJECT_ID: Incomplete
FSCTL_SET_SPARSE: Incomplete
FSCTL_SET_ZERO_DATA: Incomplete
FSCTL_QUERY_ALLOCATED_RANGES: Incomplete
FSCTL_SET_ENCRYPTION: Incomplete
FSCTL_ENCRYPTION_FSCTL_IO: Incomplete
FSCTL_WRITE_RAW_ENCRYPTED: Incomplete
FSCTL_READ_RAW_ENCRYPTED: Incomplete
FSCTL_CREATE_USN_JOURNAL: Incomplete
FSCTL_READ_FILE_USN_DATA: Incomplete
FSCTL_WRITE_USN_CLOSE_RECORD: Incomplete
FSCTL_EXTEND_VOLUME: Incomplete
FSCTL_QUERY_USN_JOURNAL: Incomplete
FSCTL_DELETE_USN_JOURNAL: Incomplete
FSCTL_MARK_HANDLE: Incomplete
FSCTL_SIS_COPYFILE: Incomplete
FSCTL_SIS_LINK_FILES: Incomplete
FSCTL_HSM_MSG: Incomplete
FSCTL_HSM_DATA: Incomplete
FSCTL_RECALL_FILE: Incomplete
FSCTL_READ_FROM_PLEX: Incomplete
FSCTL_FILE_PREFETCH: Incomplete
FSCTL_MAKE_MEDIA_COMPATIBLE: Incomplete
FSCTL_SET_DEFECT_MANAGEMENT: Incomplete
FSCTL_QUERY_SPARING_INFO: Incomplete
FSCTL_QUERY_ON_DISK_VOLUME_INFO: Incomplete
FSCTL_SET_VOLUME_COMPRESSION_STATE: Incomplete
FSCTL_TXFS_MODIFY_RM: Incomplete
FSCTL_TXFS_QUERY_RM_INFORMATION: Incomplete
FSCTL_TXFS_ROLLFORWARD_REDO: Incomplete
FSCTL_TXFS_ROLLFORWARD_UNDO: Incomplete
FSCTL_TXFS_START_RM: Incomplete
FSCTL_TXFS_SHUTDOWN_RM: Incomplete
FSCTL_TXFS_READ_BACKUP_INFORMATION: Incomplete
FSCTL_TXFS_WRITE_BACKUP_INFORMATION: Incomplete
FSCTL_TXFS_CREATE_SECONDARY_RM: Incomplete
FSCTL_TXFS_GET_METADATA_INFO: Incomplete
FSCTL_TXFS_GET_TRANSACTED_VERSION: Incomplete
FSCTL_TXFS_CREATE_MINIVERSION: Incomplete
FSCTL_TXFS_TRANSACTION_ACTIVE: Incomplete
FSCTL_SET_ZERO_ON_DEALLOCATION: Incomplete
FSCTL_SET_REPAIR: Incomplete
FSCTL_GET_REPAIR: Incomplete
FSCTL_WAIT_FOR_REPAIR: Incomplete
FSCTL_INITIATE_REPAIR: Incomplete
FSCTL_CSC_INTERNAL: Incomplete
FSCTL_SHRINK_VOLUME: Incomplete
FSCTL_SET_SHORT_NAME_BEHAVIOR: Incomplete
FSCTL_DFSR_SET_GHOST_HANDLE_STATE: Incomplete
FSCTL_TXFS_LIST_TRANSACTION_LOCKED_FILES: Incomplete
FSCTL_TXFS_LIST_TRANSACTIONS: Incomplete
FSCTL_QUERY_PAGEFILE_ENCRYPTION: Incomplete
IOCTL_VOLUME_BASE: Incomplete
IOCTL_VOLUME_GET_VOLUME_DISK_EXTENTS: Incomplete
IOCTL_VOLUME_ONLINE: Incomplete
IOCTL_VOLUME_OFFLINE: Incomplete
IOCTL_VOLUME_IS_CLUSTERED: Incomplete
IOCTL_VOLUME_GET_GPT_ATTRIBUTES: Incomplete
DDS_4mm: int
MiniQic: int
Travan: int
QIC: int
