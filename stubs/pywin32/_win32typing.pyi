...
class PyCERT_CONTEXT:
    ...
    def CertEnumCertificateContextProperties(self) -> list: ...
...
class PyCTL_CONTEXT:
    ...
    def CertEnumCTLContextProperties(self) -> tuple: ...
...
class PyConsoleScreenBuffer:
    ...
    def ReadConsoleOutputAttribute(self, Length, ReadCoord: PyCOORD) -> tuple: ...
    def WriteConsoleOutputCharacter(self, Characters, WriteCoord: PyCOORD): ...
    def WriteConsoleOutputAttribute(self, Attributes: tuple, WriteCoord: PyCOORD): ...
...
class PyIActiveScriptDebug:
    def GetScriptTextAttributes(self, pstrCode: str, pstrDelimiter: str, dwFlags) -> tuple: ...
...
class PyICreateTypeInfo:
    ...
    def SetFuncAndParamNames(self, index, rgszNames: tuple) -> None: ...
...
@final
class PyIDispatch:
    def Invoke(self, dispid, lcid, flags, bResultWanted, arg: tuple): ...
    def InvokeTypes(self, dispid, lcid, wFlags, resultTypeDesc, typeDescs: tuple, args: tuple): ...
...
class PyIMsgServiceAdmin:
    ...
    def ConfigureMsgService(self, iid: PyIID, ulUIParam, ulFlags, arg: list) -> None: ...
...
class PyIPropertyStorage:
    def ReadMultiple(self, props: tuple[PROPSPEC, ...]) -> tuple: ...
    def WriteMultiple(self, props: tuple[PROPSPEC, ...], values: tuple, propidNameFirst: int = ...) -> None: ...
    def DeleteMultiple(self, props: tuple[PROPSPEC, ...]) -> None: ...
    def ReadPropertyNames(self, props: tuple) -> tuple: ...
    def WritePropertyNames(self, props: tuple, names: tuple[str, ...]) -> None: ...
    def DeletePropertyNames(self, props: tuple) -> None: ...
...
class PyIShellItem2:
    ...
    def GetPropertyStoreForKeys(self, Keys: tuple, Flags, riid: PyIID) -> PyIPropertyStore: ...
...
class PyCColorDialog:
    ...
    def GetCustomColors(self) -> tuple: ...
...
class PyCWinApp:
    ...
    def FindOpenDocument(self, fileName: str) -> PyCDocument: ...
    def GetDocTemplatelist(self) -> list: ...
