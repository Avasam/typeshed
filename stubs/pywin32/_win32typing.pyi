...
from win32comext.directsound.directsound import DSCBUFFERDESCType
from win32comext.propsys.propsys import PROPVARIANTType

# PyIUnknown and PyIUnknown are sourced from pythoncom but are not exposed directly
# A few other modules re-expose them though
...
# PyHKEY is sourced from pywintypes but is not exposed directly
class PyHKEY:
    def Close(self): ...

# Everything below has been copied over from stubs before typeshed, and is mostly autogenerated from docs and comments
# Try to move them to their owner modules when possible. Some of these types may not even exist.
...
class PySHARE_INFO_502:
    ...
    def reserved(self): ...
    @property
    def security_descriptor(self) -> SECURITY_DESCRIPTORType: ...
...
class PyGSecurityInformation:
    ...
    def GetSecurity(self, RequestedInformation, Default, /) -> SECURITY_DESCRIPTORType: ...
    def SetSecurity(self, SecurityInformation, SecurityDescriptor: SECURITY_DESCRIPTORType, /) -> None: ...
    def GetAccessRights(self, ObjectType: IIDType, Flags, /) -> tuple[SI_ACCESS, Incomplete]: ...
    def MapGeneric(self, ObjectType: IIDType, AceFlags, Mask, /): ...
...
class PyIApplicationDocumentlists:
    def SetAppID(self, AppID, /) -> None: ...
    def Getlist(self, listType, riid: IIDType, ItemsDesired: int = ..., /) -> PyIEnumObjects: ...
...
class PyICatInformation:
    ...
    def EnumClassesOfCategories(
        self, listIIdImplemented: list[IIDType] | None = ..., listIIdRequired: Incomplete | None = ..., /
    ) -> PyIEnumGUID: ...

class PyICatRegister:
    def RegisterCategories(self, arg: list[tuple[IIDType, Incomplete, str]], /) -> None: ...
    def UnRegisterCategories(self, arg: list[IIDType], /) -> None: ...
    def RegisterClassImplCategories(self, clsid: IIDType, arg: list[IIDType], /) -> None: ...
    def UnRegisterClassImplCategories(self, clsid: IIDType, arg: list[IIDType], /) -> None: ...
    def RegisterClassReqCategories(self, clsid: IIDType, arg: list[IIDType], /) -> None: ...
    def UnRegisterClassReqCategories(self, clsid: IIDType, arg: list[IIDType], /) -> None: ...
...
class PyICategoryProvider:
    ...
    def GetCategoryName(self, guid: IIDType, /) -> None: ...
    def CreateCategory(self, guid: IIDType, riid: IIDType, /) -> None: ...

class PyIClassFactory:
    def CreateInstance(self, outerUnknown: PyIUnknown, iid: IIDType, /) -> PyIUnknown: ...
...
class PyIConnectionPoint:
    def GetConnectionInterface(self) -> IIDType: ...
...
class PyIConnectionPointContainer:
    ...
    def FindConnectionPoint(self, iid: IIDType, /) -> PyIConnectionPoint: ...

class PyIContext:
    def SetProperty(self, rpolicyId: IIDType, flags, pUnk: PyIUnknown, /) -> None: ...
    def RemoveProperty(self, rPolicyId: IIDType, /) -> None: ...
    def GetProperty(self, rGuid: IIDType, /) -> tuple[Incomplete, PyIUnknown]: ...
...
class PyICreateTypeInfo:
    def SetGuid(self, guid: IIDType, /) -> None: ...
...
class PyICustomDestinationlist:
    def SetAppID(self, AppID, /) -> None: ...
    def Beginlist(self, riid: IIDType, /) -> tuple[Incomplete, PyIObjectArray]: ...
    ...
    def GetRemovedDestinations(self, riid: IIDType, /) -> PyIObjectArray: ...
...
class PyIDebugDocumentInfo:
    ...
    def GetDocumentClassId(self) -> IIDType: ...
...
class PyIDebugProperty:
    ...
    def EnumMembers(self, dwFieldSpec, nRadix, refiid: IIDType, /) -> None: ...
...
class PyIDirectSound:
    def Initialize(self, guid: IIDType, /) -> None: ...
    def SetCooperativeLevel(self, hwnd: int, level, /) -> None: ...
    def CreateSoundBuffer(self, lpDSCBufferDesc: DSCBUFFERDESCType, unk: Incomplete | None = ..., /) -> None: ...
...
class PyIDocHostUIHandler:
    ...
    def TranslateAccelerator(self, lpMsg, pguidCmdGroup: IIDType, nCmdID, /) -> None: ...
...
class PyIDsObjectPicker:
    def Initialize(
        self, targetComputer: str, scopeInfos: DSOP_SCOPE_INIT_INFOs, options: int = ..., attrNames: list[str] | None = ..., /
    ) -> None: ...
...
class PyIEnumCATEGORYINFO:
    def Next(self, num: int = ..., /) -> tuple[tuple[IIDType, Incomplete, str], ...]: ...
...
class PyIEnumContextProps:
    def Next(self, num: int = ..., /) -> tuple[tuple[IIDType, Incomplete, PyIUnknown], ...]: ...
    def Skip(self) -> None: ...
    def Reset(self) -> None: ...
...
class PyIEnumGUID:
    def Next(self, num: int = ..., /) -> tuple[IIDType, ...]: ...
    def Skip(self, num, /) -> None: ...
    def Reset(self) -> None: ...
...
class PyIEnumObjects:
    def Next(self, riid: IIDType, num: int = ..., /) -> tuple[PyIUnknown, ...]: ...
    def Skip(self) -> None: ...
    def Reset(self) -> None: ...
...
class PyIExplorerBrowser:
    ...
    def GetCurrentView(self, riid: IIDType, /) -> PyIUnknown: ...
...
class PyIExplorerCommand:
    ...
    def GetCanonicalName(self) -> IIDType: ...
...
class PyIKnownFolder:
    def GetId(self) -> IIDType: ...
    def GetCategory(self): ...
    def GetShellItem(self, riid: IIDType, Flags: int = ..., /) -> PyIShellItem: ...
    def GetPath(self, Flags: int = ..., /): ...
    def SetPath(self, Flags, Path, /) -> None: ...
    def GetIDlist(self, Flags, /) -> PyIDL: ...
    def GetFolderType(self) -> IIDType: ...
    def GetRedirectionCapabilities(self): ...
    def GetFolderDefinition(self): ...

class PyIKnownFolderManager:
    def FolderIdFromCsidl(self, Csidl, /) -> IIDType: ...
    def FolderIdToCsidl(self, _id: IIDType, /): ...
    def GetFolderIds(self) -> tuple[IIDType, ...]: ...
    def GetFolder(self, _id: IIDType, /) -> PyIKnownFolder: ...
    def GetFolderByName(self, Name, /) -> PyIKnownFolder: ...
    def RegisterFolder(self, _id: IIDType, Definition, /) -> None: ...
    def UnregisterFolder(self, _id: IIDType, /) -> None: ...
    def FindFolderFromPath(self, Path, Mode, /) -> PyIKnownFolder: ...
    def FindFolderFromIDlist(self, pidl: PyIDL, /) -> PyIKnownFolder: ...
    def Redirect(self, _id: IIDType, hwnd: int, flags, TargetPath, Exclusion: tuple[IIDType, ...], /) -> None: ...
...
class PyIMAPIFolder:
    def GetLastError(self, hr, flags, /): ...
    def CreateFolder(
        self, folderType, folderName: str, folderComment: str | None = ..., iid: IIDType | None = ..., flags=..., /
    ) -> PyIMAPIFolder: ...
    def CreateMessage(self, iid: IIDType, flags, /) -> PyIMessage: ...
    def CopyMessages(self, msgs: PySBinaryArray, iid: IIDType, folder: PyIMAPIFolder, ulUIParam, progress, flags, /): ...
...
class PyIMAPIProp:
    ...
    def OpenProperty(self, propTag, iid: IIDType, interfaceOptions, flags, /) -> PyIUnknown: ...
    def GetIDsFromNames(self, nameIds: PyMAPINAMEIDArray, flags: int = ..., /) -> PySPropTagArray: ...
    def GetNamesFromIDs(
        self, propTags: PySPropTagArray, propSetGuid: IIDType | None = ..., flags=..., /
...
class PyIMAPISession:
    def OpenEntry(self, entryId: str, iid: IIDType, flags, /): ...
    def OpenMsgStore(self, uiParam, entryId: str, iid: IIDType, flags, /) -> PyIUnknown: ...
    ...
    def OpenAddressBook(self, uiParm, iid: IIDType, flags, /) -> PyIAddrBook: ...
    def OpenProfileSection(self, iidSection: IIDType, iid: IIDType, flags, /): ...
...
class PyIMessage:
    ...
    def OpenAttach(self, attachmentNum, interface: IIDType, flags, /) -> PyIAttach: ...
    def CreateAttach(self, interface: IIDType, flags, /) -> tuple[Incomplete, PyIAttach]: ...
...
class PyIMsgServiceAdmin:
    ...
    def ConfigureMsgService(self, iid: IIDType, ulUIParam, ulFlags, arg: list[Incomplete], /) -> None: ...
    def GetMsgServiceTable(self, flags, /) -> PyIMAPITable: ...
    def GetProviderTable(self, flags, /) -> PyIMAPITable: ...
    def DeleteMsgService(self, uuid: IIDType, /) -> None: ...
    @deprecated("This is deprecated, and there is no replacement referenced to use instead.")
    def RenameMsgService(self, uuid: IIDType, flags, newName: str, /) -> None: ...
    def OpenProfileSection(self, uuid: IIDType, iid: IIDType, flags, /): ...
    def AdminProviders(self, uuid: IIDType, flags, /): ...

class PyIMsgStore:
    def OpenEntry(self, entryId: str, iid: IIDType, flags, /): ...
    def GetReceiveFolder(self, messageClass: str | None = ..., flags: int = ..., /) -> tuple[IIDType, str]: ...
...
class PyINamedPropertyStore:
    def GetNamedValue(self, Name, /) -> PROPVARIANTType: ...
...
class PyIObjectArray:
    def GetCount(self): ...
    def GetAt(self, Index, riid: IIDType, /) -> PyIUnknown: ...
...
class PyIObjectWithSite:
    ...
    def GetSite(self, riid: IIDType, /) -> None: ...
...
class PyIPropertyChange:
    def ApplyToPropVariant(self, OrigVal: PROPVARIANTType, /) -> PROPVARIANTType: ...

class PyIPropertyChangeArray:
    def GetCount(self): ...
    def GetAt(self, Index, riid: IIDType, /) -> PyIPropertyChange: ...
...
class PyIPropertyDescription:
    ...
    def GetRelativeDescription(self, var1: PROPVARIANTType, var2: PROPVARIANTType, /) -> tuple[Incomplete, Incomplete]: ...
    ...
    def GetEnumTypelist(self, riid: IIDType, /) -> PyIPropertyEnumTypelist: ...
    def CoerceToCanonicalValue(self, Value: PROPVARIANTType, /): ...
    def FormatForDisplay(self, Value: PROPVARIANTType, Flags, /): ...
    def IsValueCanonical(self, Value, /) -> bool: ...

class PyIPropertyDescriptionAliasInfo:
    def GetSortByAlias(self, riid: IIDType, /) -> PyIPropertyDescription: ...
    def GetAdditionalSortByAliases(self, riid: IIDType, /) -> PyIPropertyDescriptionlist: ...

class PyIPropertyDescriptionlist:
    def GetCount(self): ...
    def GetAt(self, Elem, riid: IIDType, /) -> PyIPropertyDescription: ...
...
class PyIPropertyEnumType:
    ...
    def GetValue(self) -> PROPVARIANTType: ...
    def GetRangeMinValue(self) -> PROPVARIANTType: ...
    def GetRangeSetValue(self) -> PROPVARIANTType: ...
    def GetDisplayText(self) -> None: ...

class PyIPropertyEnumTypelist:
    def GetCount(self): ...
    def GetAt(self, itype, riid: IIDType, /) -> PyIPropertyEnumType: ...
    def FindMatchingIndex(self, Cmp: PROPVARIANTType, /): ...

class PyIPropertySetStorage:
    def Create(self, fmtid: IIDType, clsid: IIDType, Flags, Mode, /) -> PyIPropertyStorage: ...
    def Open(self, fmtid: IIDType, Mode, /) -> PyIPropertyStorage: ...
    def Delete(self, fmtid: IIDType, /) -> None: ...
...
class PyIPropertyStorage:
    ...
    def SetClass(self, clsid: IIDType, /) -> None: ...
    def Stat(self): ...

class PyIPropertyStore:
    def GetCount(self): ...
    def GetAt(self, iProp, /) -> PyPROPERTYKEY: ...
    def GetValue(self, Key: PyPROPERTYKEY, /) -> PROPVARIANTType: ...
    def SetValue(self, Key: PyPROPERTYKEY, Value: PROPVARIANTType, /) -> None: ...
    def Commit(self) -> None: ...

class PyIPropertyStoreCache:
    def GetState(self, key: PyPROPERTYKEY, /): ...
    def GetValueAndState(self, key: PyPROPERTYKEY, /) -> tuple[PROPVARIANTType, Incomplete]: ...
    def SetState(self, key: PyPROPERTYKEY, state, /) -> None: ...
    def SetValueAndState(self, key: PyPROPERTYKEY, value: PROPVARIANTType, state, /) -> None: ...

class PyIPropertyStoreCapabilities:
    def IsPropertyWritable(self, key: PyPROPERTYKEY, /) -> bool: ...

class PyIPropertySystem:
    def GetPropertyDescription(self, Key: PyPROPERTYKEY, riid: IIDType, /) -> PyIPropertyDescription: ...
    def GetPropertyDescriptionByName(self, CanonicalName, riid: IIDType, /) -> PyIPropertyDescription: ...
    def GetPropertyDescriptionlistFromString(self, Proplist, riid: IIDType, /) -> PyIPropertyDescriptionlist: ...
    def EnumeratePropertyDescriptions(self, Filter, riid: IIDType, /) -> PyIPropertyDescriptionlist: ...
    def FormatForDisplay(self, Key: PyPROPERTYKEY, Value: PROPVARIANTType, Flags, /): ...
...
class PyIProvideClassInfo2:
    def GetGUID(self, flags, /) -> IIDType: ...
...
class PyIRemoteDebugApplication:
    ...
    def CreateInstanceAtApplication(
        self, rclsid: IIDType, pUnkOuter: PyIUnknown, dwClsContext, riid: IIDType, /
    ) -> PyIUnknown: ...
    def QueryAlive(self) -> None: ...
...
class PyIServiceProvider:
    def QueryService(self, clsid: IIDType, iid: IIDType, /) -> PyIUnknown: ...
...
class PyIShellFolder:
    ...
    def BindToObject(self, pidl: PyIDL, pbc: PyIBindCtx, riid: IIDType, /) -> PyIShellFolder: ...
    def BindToStorage(self, pidl: PyIDL, pbc: PyIBindCtx, riid: IIDType, /): ...
    def CompareIDs(self, lparam, pidl1: PyIDL, pidl2: PyIDL, /): ...
    def CreateViewObject(self, hwndOwner, riid: IIDType, /) -> PyIShellView: ...
    def GetAttributesOf(self, pidl: tuple[PyIDL, ...], rgfInOut, /): ...
    def GetUIObjectOf(
        self, hwndOwner: int, pidl: tuple[PyIDL, ...], riid: IIDType, iidout: IIDType, Reserved=..., /
...
class PyIShellFolder2:
    def GetDefaultSearchGUID(self, pguid: IIDType, /) -> IIDType: ...
...
class PyIShellItem:
    def BindToHandler(self, pbc: PyIBindCtx, bhid: IIDType, riid: IIDType, /): ...
...
class PyIShellItem2:
    def GetPropertyStore(self, Flags, riid: IIDType, /) -> PyIPropertyStore: ...
    def GetPropertyStoreForKeys(self, Keys: tuple[Incomplete, ...], Flags, riid: IIDType, /) -> PyIPropertyStore: ...
    def GetPropertyStoreWithCreateObject(self, Flags, CreateObject: PyIUnknown, riid: IIDType, /) -> PyIPropertyStore: ...
    def GetPropertyDescriptionlist(self, Type: PyPROPERTYKEY, riid: IIDType, /) -> PyIPropertyDescriptionlist: ...
    def Update(self, BindCtx: Incomplete | None = ..., /) -> None: ...
    def GetProperty(self, key: PyPROPERTYKEY, /): ...
    def GetCLSID(self, key: PyPROPERTYKEY, /) -> IIDType: ...
...
class PyIShellItemArray:
    def BindToHandler(self, pbc: PyIBindCtx, rbhid: IIDType, riid: IIDType, /): ...
    def GetPropertyStore(self, flags, riid: IIDType, /) -> PyIPropertyStore: ...
    def GetPropertyDescriptionlist(self, Type: PyPROPERTYKEY, riid: IIDType, /) -> PyIPropertyDescriptionlist: ...
...
class PyIShellItemResources:
    ...
    def OpenResource(self, pcsir: PySHELL_ITEM_RESOURCE, riid: IIDType, /) -> PyIUnknown: ...
    def CreateResource(self, sir: PySHELL_ITEM_RESOURCE, riid: IIDType, /): ...
    def MarkForDelete(self) -> None: ...

class PyIShellLibrary:
    def LoadLibraryFromItem(self, Library: PyIShellItem, Mode, /) -> None: ...
    def LoadLibraryFromKnownFolder(self, Library: IIDType, Mode, /) -> None: ...
    def AddFolder(self, Location: PyIShellItem, /) -> None: ...
    def RemoveFolder(self, Location: PyIShellItem, /) -> None: ...
    def GetFolders(self, Filter, riid: IIDType, /) -> PyIShellItemArray: ...
    def ResolveFolder(self, FolderToResolve: PyIShellItem, Timeout, riid: IIDType, /) -> PyIShellItem: ...
    def GetDefaultSaveFolder(self, Type, riid: IIDType, /) -> PyIShellItem: ...
    def SetDefaultSaveFolder(self, Type, SaveFolder: PyIShellItem, /) -> None: ...
    def GetOptions(self): ...
    def SetOptions(self, Mask, Options, /) -> None: ...
    def GetFolderType(self) -> IIDType: ...
    def SetFolderType(self, Type: IIDType, /) -> None: ...
    def GetIcon(self): ...
    def SetIcon(self, Icon, /) -> None: ...
    def Commit(self) -> None: ...
    def Save(self, FolderToSaveIn: PyIShellItem, LibraryName, Flags, /) -> PyIShellItem: ...
    def SaveInKnownFolder(self, FolderToSaveIn: IIDType, LibraryName, Flags, /) -> PyIShellItem: ...
...
class PyIShellView:
    ...
    def GetItemObject(self, uItem, riid: IIDType, /) -> PyIUnknown: ...
...
class PyITaskScheduler:
    ...
    def Activate(self, Name, riid: IIDType, /) -> PyITask: ...
    def Delete(self, TaskName, /) -> None: ...
    def NewWorkItem(self, TaskName, rclsid: IIDType, riid: IIDType, /) -> PyITask: ...
    def AddWorkItem(self, TaskName, WorkItem: PyITask, /) -> None: ...
    def IsOfType(self, Name, riid: IIDType, /) -> bool: ...
...
class PyITransferDestination:
    ...
    def Unadvise(self, Cookie, /) -> None: ...
    def CreateItem(
        self, Name, Attributes, Size, Flags, riidItem: IIDType, riidResources: IIDType, /
    ) -> tuple[Incomplete, Incomplete, Incomplete]: ...
...
class PyITransferSource:
    ...
    def Unadvise(self, Cookie, /) -> None: ...
    def SetProperties(self, proparray: PyIPropertyChangeArray, /) -> None: ...
    def OpenItem(self, Item: PyIShellItem, flags, riid: IIDType, /) -> tuple[Incomplete, PyIShellItemResources]: ...
...
class PyITypeLib:
    ...
    def GetTypeInfoCount(self): ...
    def GetTypeInfoOfGuid(self, iid: IIDType, /) -> PyITypeInfo: ...
