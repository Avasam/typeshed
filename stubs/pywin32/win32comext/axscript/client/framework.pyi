...
class SafeOutput:
    softspace: int
    redir: Incomplete
    def __init__(self, redir: Incomplete | None = ...) -> None: ...
...
def trace(*args) -> None: ...
def RaiseAssert(scode, desc) -> None: ...
...
class AXScriptCodeBlock:
    ...
    flags: Incomplete
    beenExecuted: int
    def __init__(self, name, codeText, sourceContextCookie, startLineNumber, flags) -> None: ...
...
class COMScript:
    ...
    def CompileInScriptedSection(self, codeBlock, type, realCode: Incomplete | None = ...): ...
    def ExecInScriptedSection(self, codeBlock, globals, locals: Incomplete | None = ...) -> None: ...
    def EvalInScriptedSection(self, codeBlock, globals, locals: Incomplete | None = ...): ...
    def HandleException(self, codeBlock) -> None: ...
