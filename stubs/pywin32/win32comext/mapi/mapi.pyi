...
TBL_ASYNC: int
TBL_BATCH: int
CLSID_IConverterSession: IIDType
CLSID_MailMessage: IIDType
IID_IABContainer: IIDType
IID_IAddrBook: IIDType
IID_IAttachment: IIDType
IID_IConverterSession: IIDType
IID_IDistList: IIDType
IID_IMAPIAdviseSink: IIDType
IID_IMAPIContainer: IIDType
IID_IMAPIFolder: IIDType
IID_IMAPIProp: IIDType
IID_IMAPISession: IIDType
IID_IMAPIStatus: IIDType
IID_IMAPITable: IIDType
IID_IMailUser: IIDType
IID_IMessage: IIDType
IID_IMsgServiceAdmin: IIDType
IID_IMsgServiceAdmin2: IIDType
IID_IMsgStore: IIDType
IID_IProfAdmin: IIDType
IID_IProfSect: IIDType
IID_IProviderAdmin: IIDType
MAPI_DISTLIST: int
MSPST_UID_PROVIDER: IIDType
PSETID_Address: IIDType
PSETID_AirSync: IIDType
PSETID_Appointment: IIDType
PSETID_Common: IIDType
PSETID_Log: IIDType
PSETID_Meeting: IIDType
PSETID_Messaging: IIDType
PSETID_Note: IIDType
PSETID_PostRss: IIDType
PSETID_Remote: IIDType
PSETID_Report: IIDType
PSETID_Sharing: IIDType
PSETID_Task: IIDType
PSETID_UnifiedMessaging: IIDType
PS_INTERNET_HEADERS: IIDType
PS_MAPI: IIDType
PS_PUBLIC_STRINGS: IIDType
PS_ROUTING_ADDRTYPE: IIDType
PS_ROUTING_DISPLAY_NAME: IIDType
PS_ROUTING_EMAIL_ADDRESSES: IIDType
PS_ROUTING_ENTRYID: IIDType
PS_ROUTING_SEARCH_KEY: IIDType
