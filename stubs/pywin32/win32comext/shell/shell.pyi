...
def SHCreateDataObject(
    parent, children: list, do_inner: _win32typing.PyIDataObject, iid: _win32typing.PyIID
...
def FILEGROUPDESCRIPTORAsString(descriptors: list, arg) -> str: ...
def StringAsFILEGROUPDESCRIPTOR(buf, make_unicode: int = ...) -> list: ...
def ShellExecuteEx(
    lpVerb: str,
    lpFile: str,
    lpParameters: str,
