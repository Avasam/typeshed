...
from typing import ClassVar, Final, TextIO, TypedDict
...
class easy_install(Command):
    ...
    DEFAULT_SCHEME: Final[dict[str, str]]
...
class CommandSpec(list[str]):
    ...
    @classmethod
    def best(cls) -> type[Self]: ...
    @classmethod
    def from_param(cls, param: Self | list[str] | str | TextIO | None) -> Self: ...
    @classmethod
    def from_environment(cls) -> Self: ...
    @classmethod
    def from_string(cls, string: str | TextIO) -> Self: ...  # string could be None until 3.12, but that's deprecated anyway
...
class ScriptWriter:
    ...
    @classmethod
    def best(cls) -> type[WindowsExecutableLauncherWriter | Self]: ...
    @classmethod
