...
class Parameters:
    ...
    @property
    def client_properties(self) -> dict | None: ...
    @client_properties.setter
    def client_properties(self, value: dict | None) -> None: ...
    @property
    ...
    @property
    def tcp_options(self) -> dict | None: ...
    @tcp_options.setter
    def tcp_options(self, value: dict | None) -> None: ...
