...
_Parameters: TypeAlias = Sequence[tuple]
...
class Cursor:
    ...
    def callproc(self, procname: str, parameters: tuple = ..., overview: bool = ...) -> tuple: ...
    def close(self) -> None: ...
    def description_ext(self) -> Sequence[tuple]: ...
    def execute(self, operation: str, parameters: tuple) -> bool: ...
    ...
    def getrowsaffectedcounts(self) -> tuple: ...
