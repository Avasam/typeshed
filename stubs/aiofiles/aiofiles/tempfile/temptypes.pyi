...
class AsyncSpooledTemporaryFile(AsyncBase[_T]):
    def fileno(self) -> Generator: ...
    def rollover(self) -> Generator: ...
    ...
    async def readlines(self, __hint: int = ...) -> list: ...
    # ---
    ...
    async def writelines(self, iterable: Iterable) -> None: ...

class AsyncTemporaryDirectory:
    async def cleanup(self) -> None: ...
    @property
    def name(self) -> Incomplete: ...  # should be `AnyStr`
    def __init__(self, file: TemporaryDirectory, loop: AbstractEventLoop | None, executor: Incomplete | None) -> None: ...
    async def close(self) -> None: ...
