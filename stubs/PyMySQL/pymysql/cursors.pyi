...
class SSCursor(Cursor):
    def fetchall(self) -> list[tuple]: ...  # type: ignore[override]
    def fetchall_unbuffered(self) -> Iterator[tuple]: ...
    def scroll(self, value: int, mode: str = ...) -> None: ...
