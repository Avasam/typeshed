...
class croniter(Iterator):
    ...
    __next__ = next
    def all_next(self, ret_type: _RetType | None = ...) -> Iterator: ...
    def all_prev(self, ret_type: _RetType | None = ...) -> Iterator: ...
    def iter(self, ret_type: _RetType | None = ...) -> Iterator: ...
