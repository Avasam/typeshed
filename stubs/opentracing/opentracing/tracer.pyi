...
class Tracer:
    ...
    def inject(self, span_context: SpanContext, format: str, carrier: dict) -> None: ...
...
def start_child_span(parent_span: Span, operation_name: str, tags: dict | None = ..., start_time: float | None = ...) -> Span: ...
