...
class Connection(Connectable):
    ...
    @overload
    def execute(self, statement: str, *multiparams: Any | tuple | Mapping[str, Any], **params) -> CursorResult: ...
...
class Engine(Connectable, Identified):
    ...
    @overload
    def execute(self, statement: str, *multiparams: Any | tuple | Mapping[str, Any], **params: Any) -> CursorResult: ...
    @overload  # type: ignore[override]
    def scalar(self, statement: _Executable, *multiparams: Mapping[str, Any], **params: Any) -> Any: ...
    @overload
    def scalar(self, statement: str, *multiparams: Any | tuple | Mapping[str, Any], **params: Any) -> Any: ...
