...
class _DeclarativeBase(Any):  # super classes are dynamic
    ...
    __mapper_cls__: ClassVar
    __class_getitem__: ClassVar

# Meta class (or function) that creates a _DeclarativeBase class.
_DeclarativeBaseMeta: TypeAlias = Callable[[str, tuple[type, ...], dict[str, Any]], _DeclT]

def has_inherited_table(cls: type) -> bool: ...

class DeclarativeMeta(type):
    def __init__(cls, classname: str, bases: tuple[type, ...], dict_: dict[str, Any], **kw: object) -> None: ...
...
def declarative_base(
    ...
    class_registry: dict[str, type] | None = ...,
...
class registry:
    ...
    @property
    def mappers(self) -> frozenset: ...
    def configure(self, cascade: bool = ...) -> None: ...
    def dispose(self, cascade: bool = ...) -> None: ...
    @overload
    def generate_base(
        self, mapper: Any | None = ..., cls: type | tuple[type, ...] = ..., name: str = ...
    ) -> type[_DeclarativeBase]: ...
    @overload
    def generate_base(
        self,
    ...
    @overload
    def generate_base(
        self, mapper: Any | None, cls: type | tuple[type, ...], name: str, metaclass: _DeclarativeBaseMeta[_DeclT]
    ) -> type[_DeclarativeBase]: ...
