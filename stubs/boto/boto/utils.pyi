...
def find_class(module_name: str, class_name: str | None = ...) -> type | None: ...
...
def compute_md5(fp: IO, buf_size: int = ..., size: int | None = ...) -> tuple[str, str, int]: ...
def compute_hash(fp: IO, buf_size: int = ..., size: int | None = ..., hash_algorithm: Any = ...) -> tuple[str, str, int]: ...
